...
- **주간 Superstar 가설 감사** — 최근 근거를 Luna 1회/Terra 최대 1회로 제한해 CUDA형 플랫폼 6단계와 문서 기반 v2 필터를 감사한다. 현재 코퍼스에는 권위 있는 4~8분기 재무·valuation·경영진 실행 측정치가 없어 후보를 분류하거나 발행하지 않는다
